...
export const fetchAcceptancesReducer = (state, action) => {
    switch (action.type) {
        case `${FETCH_ACCEPTANCES_PENDING_ACTION_PREFIX}_request`: {
            return {
                ...state,
                fetching: true,
                error: null,
        ...
        case `${FETCH_ACCEPTANCES_PENDING_ACTION_PREFIX}_success`: {
            return {
                ...state,
                fetching: false,
        ...
        case `${FETCH_ACCEPTANCES_PENDING_ACTION_PREFIX}_failure`: {
            return {
                ...state,
                fetching: false,
                error: action.error,
