ALTER TABLE history_logs ADD COLUMN details_change_event varchar(60) DEFAULT NULL;

INSERT INTO history_logs (created, user_id, user_work_time, hours,  "comment",	details_change_event)
