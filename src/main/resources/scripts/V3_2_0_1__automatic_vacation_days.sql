...
INSERT INTO automatic_vacation_days (id, created, modified, user_id)
SELECT nextval('seq_automatic_vacation_days'), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, id  FROM users;