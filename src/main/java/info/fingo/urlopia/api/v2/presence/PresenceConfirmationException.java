...
public class PresenceConfirmationException extends BaseCustomException {
    ...
    private static final String USER_NOT_WORKING_DAY_MSG = "You cannot confirm a presence in a day you are not working";
    ...
    public static PresenceConfirmationException userNonWorkingDay() {
        return new PresenceConfirmationException(USER_NOT_WORKING_DAY_MSG);
    }
